...
export const MobileNavDrawer: React.FC<MobileNavDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden flex">
      ...
      {/* Drawer Container */}
      <div className="relative w-4/5 max-w-sm h-full bg-zinc-950/95 border-r border-white/10 p-5 flex flex-col justify-between z-10 shadow-2xl overflow-y-auto">
